...
const REALMS = [
  ...
  {
    key: '아귀', name: '아귀 (餓鬼)', minScore: -30, maxScore: -1,
    emoji: '👻', glowColor: '#8b6914',
    desc: '탐욕의 업보로 아귀의 몸을 받습니다.\n늘 굶주리지만 먹을 수 없는 고통의 세계입니다.',
  },
  {
    key: '축생', name: '축생 (畜生)', minScore: -60, maxScore: -31,
    emoji: '🐾', glowColor: '#2d6a2d',
    desc: '어두운 업보로 짐승의 몸을 받습니다.\n본능에 따라 살아가는 고통의 세계입니다.',
  },
  {
    key: '지옥', name: '지옥 (地獄)', minScore: -100, maxScore: -61,
...
const PIXEL_CHARS = {
  ...
  아귀: {
    // 창백한 피부, 볼록한 배, 가는 목, 공허한 눈
    palette: ['', '#c8c0a0', '#e8e0c0', '#8b8070', '#4a4030', '#ff6600', '#000000', '#ffffff'],
    map: [
      '0000000000000000',
      '0000033300000000',
      '0000322230000000', // 작은 머리
      '0003277230000000', // 공허한 눈 (7=검정)
      '0003222230000000',
      '0000322300000000',
      '0000031300000000', // 가는 목
      '0000031300000000',
      '0001133110000000', // 볼록 배 시작
      '0011333111000000',
      '0013333311000000', // 볼록 배
      '0013333311000000',
      '0011333111000000',
      '0001133110000000',
      '0000011100000000', // 가는 다리
      '0000011100000000',
    ],
  },
